						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								...
								<span>
									...
									<a href="<?= Url::to(['cart/add', 'id' => $product->id])?>" data-id="<?= $product->id ?>" href="<?= Url::to(['cart/add', $product->id]) ?>" type="button" class="btn btn-fefault cart add-to-cart">
                ...
                <?php endif; ?>
									<div class="col-sm-4">
										<div class="product-image-wrapper">
											<div class="single-products">
												<div class="productinfo text-center">
                        <?= Html::img('/images/products/' . $hit->img, ['style' => 'width: 134px; height: 134px; object-fit: contain', 'alt' => $hit->name]) ?>
													<h2>$<?= $hit->price ?></h2>
